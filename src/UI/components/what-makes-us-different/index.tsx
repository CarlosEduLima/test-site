...
import { Container, ContentLine, Text, Divider, SubTitle, Title, Image, SubContentRight, SubContentLeft, StyledLink } from './styles'
  ...
  return (
    <Container>
      ...
      <ContentLine>
        ...
        <SubContentRight>
          <Image src={startupIdea} />
        </SubContentRight>
      </ContentLine>

      <ContentLine>
        <SubContentLeft>
          <Image src={workRiskFree} />
        </SubContentLeft>
        <SubContentRight>
          <SubTitle>Como faço para ser um profissional IZiW?</SubTitle>
          <Text><Link href="/temp"><StyledLink>Clique aqui</StyledLink></ Link> e será redirecionado para nosso formulário de inscrição.</Text>
        </SubContentRight>
      </ContentLine>
    </Container>
)}